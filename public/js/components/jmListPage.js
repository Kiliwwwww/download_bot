...
export function createJmListPage(Vue, naive) {
    ...
    const {NCard, NConfigProvider, NButton, NPagination, NSpin, NSwitch, NTabs, NTabPane} = naive
...
<!--            </h2>-->
          ...
          <!-- 返回按钮 -->
          <n-button style="margin-top:10px;" @click="goto('/')">返回主页</n-button>
    ...
    `,
        setup() {
            ...
            return {
                items, page, totalPages, perPage, loading,
                type, pageTitle, pageTitleArr, fetchList,
                goBack, cardStyle, goto,
                privacyMode, themeOverrides,
                JmDetailModal, JmBottomBarComponent
            }
        },
        components: {NCard, NConfigProvider, NButton, NPagination, NSpin, NSwitch, NTabs, NTabPane}
    }
}
